...
const WelcomeNotification = (theme, rtl, setIsNotificationShown, isNotificationShown) => {
  const title = 'Welcome to the DoorStep Delhi!';
  const message = 'You have successfully registered in the DpprStep Delhi Seller Portal. Now you can start to explore the dashboard'
